...
class CLIPWrapper(pl.LightningModule):
    ...
    # @property
    #edited following: https://github.com/Zasder3/train-CLIP/issues/29
    ...
    def validation_step(self, val_batch, idx):
        ...
        image_logits, text_logits = self.model.forward(image.long().to('cuda'), text.long().to('cuda')) #AK: self model.forward?
